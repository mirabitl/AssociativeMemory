...
extern "C" void ListHoughPointCPU(int maxblock,int maxthread,unsigned int* d_hough,unsigned int* d_hough_layer,unsigned int min_val,unsigned int min_layer,unsigned int* d_cand,houghLimits hl);
...
extern "C" void createHoughCPU(houghParam* p);
