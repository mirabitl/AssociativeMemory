#ifndef _HOUGHCARTESIAN_H

#define _HOUGHCARTESIAN_H
#include <vector>
#include<stdint.h>
...
public:
	...
	HoughCartesian(double thmin,double thmax,double rmin,double rmax,uint32_t nbintheta=8,uint32_t nbinr=8);
	~HoughCartesian();
